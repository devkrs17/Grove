...
export const seed = async (payload: Payload): Promise<void> => {
  ...
  // Highgrove's catalogue is the real brand packs (Litt Edibles, 710 Nomad
  // Rosin, Blinkers Flip), populated from committed CSV + photos via
  // `pnpm --filter @grove/web import:packs` — intentionally not seeded here.
