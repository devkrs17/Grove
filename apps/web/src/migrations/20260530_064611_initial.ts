...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_products_category" AS ENUM('Flower', 'Concentrates', 'Vapes', 'Pre-rolls', 'Edibles');
  CREATE TYPE "public"."enum_products_strain_type" AS ENUM('Indica', 'Sativa', 'Hybrid');
  CREATE TYPE "public"."enum_products_effect" AS ENUM('sleep', 'chill', 'euphoric', 'creative', 'focus');
  CREATE TYPE "public"."enum_site_memberships_role" AS ENUM('owner', 'manager', 'worker');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_homepage_category_tiles_category" AS ENUM('Flower', 'Concentrates', 'Vapes', 'Pre-rolls', 'Edibles');
  ...
  CREATE TABLE "products" (
  	...
  	"strain_type" "enum_products_strain_type",
  	"effect" "enum_products_effect",
  	"thc_label" varchar,
  	"lot" varchar,
  	"tag" varchar,
  ...
  CREATE TABLE "homepage_hero_stickers" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" varchar
  ...
  CREATE TABLE "homepage_category_tiles" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"category" "enum_homepage_category_tiles_category",
  	"image_id" integer
  );
  ...
  ALTER TABLE "homepage_hero_stickers" ADD CONSTRAINT "homepage_hero_stickers_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "homepage_category_tiles" ADD CONSTRAINT "homepage_category_tiles_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "homepage_reviews" ADD CONSTRAINT "homepage_reviews_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "homepage_hero_stickers_order_idx" ON "homepage_hero_stickers" USING btree ("_order");
  CREATE INDEX "homepage_hero_stickers_parent_id_idx" ON "homepage_hero_stickers" USING btree ("_parent_id");
  ...
  CREATE INDEX "homepage_category_tiles_image_idx" ON "homepage_category_tiles" USING btree ("image_id");
  CREATE INDEX "homepage_reviews_order_idx" ON "homepage_reviews" USING btree ("_order");
  CREATE INDEX "homepage_reviews_parent_id_idx" ON "homepage_reviews" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "homepage_hero_stickers" CASCADE;
  ...
  DROP TYPE "public"."enum_products_strain_type";
  DROP TYPE "public"."enum_products_effect";
  DROP TYPE "public"."enum_site_memberships_role";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_version_status";
  DROP TYPE "public"."enum_homepage_category_tiles_category";
